...
2. **格式校验**
   - 验证 JSON Schema 必需字段（id, title, source_url, source_type, summary, key_points, technical_depth, tags, published_at, collected_at, status, score, metadata, multi_dim_scores 等）
